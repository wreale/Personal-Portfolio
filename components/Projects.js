...
const Projects = () => {
    return <div>
        ...
        <Project name={"IST 363 Final Project - Subaru"} slug={"ist363-final-project"}>This is my final project for my Advanced Front-End Web Dev Course. After really enjoying my intro course, I enrolled in this class for the spring of my sophomore year. Throughout the course we focused more on JavaScript, while also learning how to use React, Node.js, Sass, and WordPress. This final project incorporates all those skills.</Project>
