...
const Projects = () => {
    return <div>
        ...
        <Project name={"FutureFour College Consulting"} slug={"future-four-consulting"} href={"https://www.futurefourconsulting.com/"}>This is a comprehensive portfolio site for a college counseling service. The site uses React, Next.js, and Sass for the frontend and Strapi as a headless CMS so the client can manage and update various aspects of the website. Being my first freelance project, I learned more than I could have imagined, and look forward to similar projects in the future.</Project>
